...
//		System.out.println(stu);
	...
	@Test
	public void test3(){
		ClassNameMapper clsNameMap = ops.getMapper(ClassNameMapper.class);
		//ClassName cls = clsNameMap.selectByCustom1(1);
		ClassName cls = ops.selectOne("ls.dao.ClassNameMapper.selectByCustom1", 1);
